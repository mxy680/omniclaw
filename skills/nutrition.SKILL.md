---
name: nutrition
description: Track food, meals, pantry, and daily nutrition notes with a local SQLite database. No external API or auth needed.
metadata: {"openclaw": {"emoji": "🥗"}}
---

# Nutrition Tracking

Log food, manage your pantry, plan meals, and track daily nutrition in a local SQLite database. No external API, no authentication — everything stays on your machine.
...
4. Use `nutrition_notes` to jot down daily observations.
