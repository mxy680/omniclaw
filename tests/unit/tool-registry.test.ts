...
describe("createAllTools", () => {
  it("returns non-OAuth tools with no OAuth config", () => {
    ...
    // Without client_secret_path, only non-OAuth tools: YouTube (2) + Schedule (5) + Soul (2) + Attachment (1) + GitHub (102) + Gemini (4) + Wolfram (2) + LinkedIn (11) + Instagram (14) + Framer (59)
